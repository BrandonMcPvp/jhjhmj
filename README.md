...
local guiHelperDrawDistance = gui.Slider(guiHelperSettingsBlock, "nade_draw_dist", "Draw Distance", 700, 0, 1000);
local guiHelperPDrawDistance = gui.Slider(guiHelperSettingsBlock, "nade_pdraw_dist", "Draw Pointer Distance", 30, 0, 100);
local guiHelperActivationDistance = gui.Slider(guiHelperSettingsBlock, "nade_activation_dist", "Helper Activation Distance", 30, 0, 300);
local guiHelperFov = gui.Slider(guiHelperSettingsBlock, "nade_fov", "Helper FOV", .50, 0, 250);
